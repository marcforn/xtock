package mforn.io.core.data.network.configuration.api

import kotlinx.coroutines.Deferred
import mforn.io.core.data.network.configuration.PATH_SECTOR_PERFORMANCE
import mforn.io.core.data.network.configuration.PATH_STOCK
import mforn.io.core.data.network.configuration.PERIOD
import mforn.io.core.data.network.configuration.STOCK
